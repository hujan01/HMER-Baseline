...
Date: 2020-12-29 19:21:59
LastEditTime: 2020-12-29 19:40:55
'''
import os
import sys
...
latex_root_path = 'data/label/'
gtd_root_path = 'data/CROHME_gtd/'
gtd_paths = ['test_caption', 'train_caption', 'test2016']
